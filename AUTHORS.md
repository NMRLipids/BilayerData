...
The FAIRMD Lipids (formerly NMRlipids) project has been run by [NMRlipids research collaboration](https://nmrlipids.blogspot.com/) since 2013.

# Contributors

FAIRMD Lipids Databank separates [codespace](https://github.com/NMRLipids/FAIRMD_lipids) from Data since June 2025 (v.1.1.0). Here we list contributors of the data part only; the contributors of the Databank core code are listed in [FAIRMD_lipids/AUTHORS.md](https://github.com/NMRLipids/FAIRMD_lipids/blob/main/AUTHORS.md).
...
- Fernando Favela-Rosales (@ffavelar)
