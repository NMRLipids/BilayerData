# FAIRMD BilayerData
FAIRMD BilayerData is an on-github database of lipid bilayer structures operated by the [FAIRMD Lipids](https://github.com/NMRlipids/FAIRMD_lipids) Project. The database contains information about:
...
- molecules with their metadata

The database doesn't store raw data; it refers to public archives like Zenodo, where complete trajectories must be stored. The database structure is described in detail in the [FAIRMD Lipids documentation](https://nmrlipids.github.io/FAIRMD_lipids/stable/dbstructure.html).
